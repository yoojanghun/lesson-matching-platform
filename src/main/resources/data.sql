...
INSERT IGNORE INTO tutor_account (tutor_id, introduction, experiences, title, educations, average_rating, review_count, matching_count, created_at, created_by)
VALUES
(1, '기초부터 탄탄하게 가르치는 피아니스트 김철수입니다.', '["한예종 졸업", "독일 유학 5년", "다수 콩쿠르 입상"]', '지루한 체르니는 그만! 뉴에이지부터 클래식까지 1:1 맞춤 레슨', '["수강생의 수준에 맞춰 커리큘럼을 조정합니다. 성인 취미반 적극 환영합니다."]', 0, 0, 10, NOW(), 'SYSTEM'),
(2, '바이올린의 아름다운 선율을 함께 만들어봐요.', '["시립교향악단 단원 역임", "레슨 경력 10년"]', '초보자도 3개월 만에 한 곡 마스터! 바이올린 기초 완성', '["정확한 자세와 활 쓰기 기법을 중심으로 지도합니다. 악기 대여 상담도 가능해요."]', 0, 0, 1, NOW(), 'SYSTEM'),
(3, '첼로의 깊은 울림을 전달하는 박현우입니다.', '["해외 음악제 초청 연주", "예술고등학교 출강"]', '직장인을 위한 힐링 첼로 클래스 (저녁 시간대 가능)', '["바쁜 일상 속에서 악기를 배우며 힐링하고 싶은 분들을 위해 유연한 스케줄을 제공합니다."]', 0, 0, 1, NOW(), 'SYSTEM'),
(4, '통기타부터 일렉기타까지, 리듬을 즐겨보세요.', '["실용음악과 졸업", "밴드 세션 활동 중"]', '한 달 만에 완성하는 통기타 코드와 스트로크', '["자신이 좋아하는 곡을 직접 연주하며 노래할 수 있도록 실전 위주로 가르칩니다."]', 0, 0, 1, NOW(), 'SYSTEM'),
(5, '당신이 가진 최고의 악기, 목소리를 찾아드립니다.', '["유명 오디션 프로그램 코칭", "보컬 트레이너 경력"]', '고음 불가 탈출! 호흡부터 발성까지 체계적인 보컬 트레이닝', '["성대 결절 예방과 올바른 발성법을 통해 자신감 있게 노래할 수 있게 돕습니다."]', 0, 0, 1, NOW(), 'SYSTEM'),
(6, '스트레스를 한 번에 날리는 파워풀한 드럼 레슨!', '["재즈 클럽 정기 공연", "드럼 전문 아카데미 운영"]', '박치 탈출! 기초 비트부터 화려한 필인까지', '["리듬감이 없어도 괜찮습니다. 메트로놈과 친해지는 법부터 차근차근 알려드립니다."]', 0, 0, 1, NOW(), 'SYSTEM'),
(7, '음악의 뼈대, 베이스 기타의 매력에 빠져보세요.', '["실용음악과 석사", "다수 인디 밴드 앨범 참여"]', '그루브가 살아있는 베이스 기타 중급/입문 레슨', '["단순 반복이 아닌, 곡의 흐름을 이해하는 연주법을 중심으로 레슨을 진행합니다."]', 0, 0, 0, NOW(), 'SYSTEM'),
(8, '러시아 유학파 출신의 정통 클래식 피아노 레슨입니다.', '["모스크바 국립 음악원 졸업", "독주회 10회 이상"]', '기초부터 고급 입시까지, 정통 클래식 피아노의 정석', '["테크닉뿐만 아니라 곡의 해석과 감수성을 풍부하게 표현하는 방법을 지도합니다."]', 0, 0, 0, NOW(), 'SYSTEM'),
(9, '딱딱한 악보 대신 리듬을 배우는 재즈 피아노입니다.', '["실용음악과 졸업", "재즈 밴드 리더"]', '코드 반주부터 화려한 즉흥 연주까지! 재즈 피아노 입문', '["팝, 재즈, 가요 반주를 원하는 분들을 위한 맞춤형 커리큘럼을 제공합니다."]', 0, 0, 0, NOW(), 'SYSTEM'),
(10, '누구나 쉽고 재미있게 시작하는 성인 취미 피아노입니다.', '["음악교육 석사", "개인 레슨 경력 8년"]', '퇴근 후 나만의 힐링 시간, 한 달 한 곡 완성 프로젝트', '["악보를 전혀 못 보셔도 괜찮습니다. 친절하게 기초부터 알려드려요."]', 0, 0, 1, NOW(), 'SYSTEM'),
(11, '아이들의 눈높이에 맞춘 즐거운 음악 수업입니다.', '["유아 음악 지도사 자격증 보유"]', '창의력을 키워주는 어린이 놀이 피아노 레슨', '["단순 연습이 아닌 음악적 놀이를 통해 자연스럽게 피아노와 친해지게 합니다."]', 0, 0, 0, NOW(), 'SYSTEM'),
(12, '마음을 울리는 서정적인 뉴에이지 연주를 가르칩니다.', '["음반 3장 발매", "작곡가 활동 중"]', '영화 OST, 뉴에이지 명곡 마스터 클래스', '["히사이시 조, 이루마 등 감성적인 곡들을 직접 연주해보고 싶은 분들을 모십니다."]', 0, 0, 1, NOW(), 'SYSTEM'),
(13, '독일 오케스트라 수석 출신의 디테일한 레슨입니다.', '["독일 베를린 국립음대 졸업", "현직 오케스트라 수석"]', '전공생 및 오케스트라 오디션 대비 심화 클래스', '["보잉의 각도 하나까지 세밀하게 교정하여 최고의 소리를 찾아드립니다."]', 0, 0, 0, NOW(), 'SYSTEM'),
(14, '바이올린은 첫 자세가 가장 중요합니다.', '["음대 바이올린 전공", "청소년 오케스트라 지도"]', '바이올린 기초 탄탄! 예쁜 소리 만들기 프로젝트', '["어깨 통증 없는 올바른 자세와 정확한 음정을 잡는 법을 집중 교육합니다."]', 0, 0, 1, NOW(), 'SYSTEM'),
(15, '취미로 시작해서 평생 친구가 되는 바이올린 레슨', '["레슨 경력 12년", "다수 동호회 지도"]', '성인 취미반 전문! 쉽고 빠르게 배우는 바이올린', '["지루한 연습곡 대신 유명한 소품곡 위주로 쉽고 재미있게 수업합니다."]', 0, 0, 0, NOW(), 'SYSTEM'),
(16, '현악 사중주 등 앙상블 수업도 가능한 전문가입니다.', '["실내악 앙상블 팀 운영", "대학 출강"]', '함께 연주하는 즐거움, 바이올린 앙상블 및 개인 레슨', '["혼자 연주하는 것을 넘어 다른 악기와 호흡을 맞추는 방법까지 배울 수 있습니다."]', 0, 0, 0, NOW(), 'SYSTEM'),
(17, '입시와 콩쿠르 준비를 위한 확실한 성과 중심 레슨', '["국내 유명 콩쿠르 심사위원", "예고 입시 합격자 다수 배출"]', '확실한 실력 향상! 예중/예고/음대 입시 전문 지도', '["수강생의 단점을 정확히 파악하여 단기간에 실력을 끌어올리는 전략적 레슨입니다."]', 0, 0, 0, NOW(), 'SYSTEM');
